...
class topshop_ctl_promotion_package extends topshop_controller {
    ...
    {
        $this->contentHeaderTitle = app::get('topshop')->_('添加/编辑组合促销');
        ...
        if($apiData['package_id'])
        {
            ...
            {
                return $this->splash('error','','您没有权限编辑此组合促销',true);
            }
    ...
    public function submit_approve(){
        ...
        $this->sellerlog('更新组合促销。组合促销ID是 '.$apiData['package_id']);
        $url = url::action('topshop_ctl_promotion_package@list_package');
    ...
    public function delete_package()
    {
        ...
        $msg = app::get('topshop')->_('删除组合促销成功');
        return $this->splash('success', $url, $msg, true);
    }
