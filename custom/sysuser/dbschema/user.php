...
return array (
    ...
    array (
        ...
        array (
            ...
            'unsigned' => false,
            'comment' => app::get('sysuser')->_('会员生日'),
        ),
        'sex' =>
        array (
            'type' =>
		...
		'touch_name'=>array(
			'type'=>'string',
			'length'=>50,
			'label'=> app::get('sysuser')->_('联系人姓名'),
			'comment'=> app::get('sysuser')->_('联系人姓名'),
		),	
		'business_img'=>array(
			'type'=>'string',
			'label'=> app::get('sysuser')->_('营业执照'),
			'comment'=> app::get('sysuser')->_('营业执照'),
		),	
		'company_name'=>array(
			'type'=>'string',
			'label'=> app::get('sysuser')->_('公司名称'),
			'comment'=> app::get('sysuser')->_('公司名称'),
		),		
    ),
