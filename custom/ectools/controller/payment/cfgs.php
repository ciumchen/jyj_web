...
class ectools_ctl_payment_cfgs extends desktop_controller{
    ...
    public function _views(){
        ...
        $xcx_filter = array('platform'=>'iswxxcx', 'is_frontend' => false);
        ...
        $xcx_num = count($o->getList('*',$xcx_filter));
        $show_menu = array(
            ...
            5=>array('label'=>app::get('ectools')->_('微信小程序'),'optional'=>false,'addon'=>$xcx_num,    'filter'=>$xcx_filter),
        );
        return $show_menu;
    }
