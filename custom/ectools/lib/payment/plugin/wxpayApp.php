...
final class ectools_payment_plugin_wxpayApp extends ectools_payment_app implements ectools_interface_payment_app { 
    ...
    protected function get_html($payment_id){
        ...
        $arr['payment_id_pay']       = $payment_id    ;//add by sk2017年10月18日17:15:04
        $arr['pay_id']       = 'wxpayApp'    ;//add by sk2017年10月18日17:15:04
        $arr['packagevalue']     = $this->fields['package']  ;//add by sk2017年10月18日17:15:04
        ...
        $lastarr['data']=$arr;
        $lastarr['status']['succeed']=1;


        $json = json_encode($lastarr);
        echo $json;exit;
        return $json;
    }
...
/* 以下为退款代码 ↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓ */
    ...
    public function dorefund($payment)
    {
        ...
        $result   = $this->xmlToArray($response);
        file_put_contents(DATA_DIR.'/testWeixinrefundPay.txt', date("Y-m-d H:i:s")."-xml-".var_export($xml,true)."\r\n",FILE_APPEND);


        file_put_contents(DATA_DIR.'/testWeixinrefundPay.txt', date("Y-m-d H:i:s")."-result-".var_export($result,true)."\r\n",FILE_APPEND);
