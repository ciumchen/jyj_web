...
class sysaftersales_api_apply {
    ...
    public function getParams()
    {
        $return['params'] = array(
            ...
            'user_id'         => ['type'=>'int',    'valid'=>'required|numeric',  'title'=>'会员的id',         'desc'=>'会员的id'],
            'num'         	  => ['type'=>'int',    'valid'=>'required|numeric',  'title'=>'申请售后的数量', 'desc'=>'申请售后的数量'],
            ...
            'aftersales_type' => ['type'=>'string', 'valid'=>'',                  'title'=>'售后服务类型',     'desc'=>'售后服务类型(ONLY_REFUND:只退款，REFUND_GOODS:退货退款，EXCHANGING_GOODS:换货) 默认为只退款'],
        );
