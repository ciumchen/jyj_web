...
class sysitem_api_item_create {
    ...
    public function getParams()
    {
        $return['params'] = array(
            ...
            'grade_price' => ['type'=>'string','valid'=>'','description'=>'商品级别的等级折扣'],
            'step_price' => ['type'=>'string','valid'=>'','description'=>'商品级别的阶梯价'],
            
            'mini_quantity' => ['type'=>'numeric','valid'=>'min:1','description'=>'最小起订量'],
            ...
            'sku' => ['type'=>'jsonArray', 'valid'=>'required_if:nospec,0', 'example'=>'', 'description'=>'sku信息' ,'params' => [
                ...
                'grade_price' => ['type'=>'string',  'valid'=>'', 'description'=>'等级折扣'],
                'step_price' => ['type'=>'string',  'valid'=>'', 'description'=>'阶梯价'],
