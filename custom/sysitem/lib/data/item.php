...
class sysitem_data_item {
    ...
    private function __formatItemData( $postData )
    {
        ...
        $data['step_price'] = $postData['step_price'];//@zm
        $data['grade_price'] = $postData['grade_price'];
        
        $data['mini_quantity'] = $postData['mini_quantity'];//@zm
    ...
    private function __formatSkuData( $postData, $item)
    {
        ...
        foreach ($postData['sku'] as $val) {
            ...
            $data['grade_price'] = $val['grade_price']; //@zm 等级价
            $data['step_price'] = $val['step_price']; //@zm 阶梯价  
            $data['mini_quantity'] = $val['mini_quantity']; //@zm 阶梯价  
            $objMdlSku->save($data);
            $skus[] = $data;
        }
