...
class topc_ctl_item extends topc_controller {
    ...
    public function index()
    {
        ...
        $params['fields'] = "*,item_desc.pc_desc,item_count,item_store,item_status,sku,item_nature,spec_index,grade_price";
    ...
    function getSpecSku()
    {
        ...
        $params['fields'] = "grade_price,spec_desc,sku";
        $detailData = app::get('topc')->rpcCall('item.get',$params);
	...
	//	echo '<pre>';var_dump($detailData['spec']);
        $detailData['qrCodeData'] = $this->__qrCode($itemId);
        $pagedata['item'] = $detailData;
