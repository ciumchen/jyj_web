...
class toputil_im_plugin_webcall implements toputil_im_interface
{
    ...
    //浮动系列
    //浮动图标或者浮动列表模式下使用
    var $floatUrl = "https://p.365webcall.com/IMMeForPartner.aspx";

    //固定图标系列
    //这个是打开聊天页面的地址
    //这个暂时弃用
    var $chatUrl = "https://p.365webcall.com/chat/ChatWinForPartner.aspx";

    //固定图标2系列
    //不显示在线状态
    var $chatUrlLess = "https://p.365webcall.com/chat/ChatWinCorp.aspx";
