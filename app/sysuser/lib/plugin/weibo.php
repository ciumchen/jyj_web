...
class sysuser_plugin_weibo extends sysuser_plugin_abstract implements sysuser_interface_trust
{
    ...
    public function generateAccessToken($code)
    {
        ...
        try
        {
            $msg = client::post($this->getUrl('token'), ['form_params' => $args])->getBody();
    ...
    public function generateOpenId()
    {
        ...
        $msg = client::post($this->getUrl('openid'), ['form_params' => $args])->getBody();
        $msg = json_decode($msg, 1);
    ...
    public function generateUserInfo()
    {
        ...
        $msg = client::get($this->getUrl('userinfo'), ['query' => $args])->getBody();
        $msg = json_decode($msg, 1);
