        ...
        try
        {
            ...
            if(!$params['is_free'])
            {
                ...
                if($params['valuation']=='2' && $params['fee_number_conf']){
                    if(!$params['fee_number_conf'][0]['start_standard'] || !isset($params['fee_number_conf'][0]['add_fee']) || !$params['fee_number_conf'][0]['add_standard'] || !isset($params['fee_number_conf'][0]['start_fee']))
                    {
