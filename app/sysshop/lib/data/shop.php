...
class sysshop_data_shop {
    ...
    public function openShop($enterapplyId)
    {
        ...
        $sellerInfo = $objMdlSeller->getRow("*",array('seller_id'=>$sellerId));
        ...
        $shop['company_name'] = $params['company_name'];
        $shop['open_time'] = time();
        $shop['status'] = 'active';
        ...
        try
        {
            ...
            //0325版本修改
            $shopInfo['enroll_capital'] = 'enroll_capital';
            $shopInfo['scope'] = 'scope';
            $shopInfo['company_area'] = 'company_area';
            $shopInfo['company_contacts'] = $shopInfo['representative'];
            $shopInfo['company_cmobile'] = $sellerInfo['mobile'];
            $shopInfo['company_name'] = $params['company_name'];
            $shopInfo['tissue_code'] = 'tissue_code';
            $shopInfo['tax_code'] = 'tax_code';
            $shopInfo['bank_area'] = 'bank_area';

            $shopInfo['establish_date'] = time();
            $shopInfo['license_indate'] = time() + 365*10*24*3600;
