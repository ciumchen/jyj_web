 ...
 * topapi
 *
 * -- statement.shop.trade.aftersale.analyze.chart
 * -- 问题订单分析图表数据
 *
 * @copyright  Copyright (c) 2005-2016 ShopEx Technologies Inc. (http://www.shopex.cn)
 * @license  http://ecos.shopex.cn/ ShopEx License
 */
class topmanageapi_api_v1_statement_orderAftersaleAnalyzechart implements topmanageapi_interface_api{

    /**
     * 接口作用说明
     */
    public $apiDescription = '问题订单分析图表数据';
 ...
 */
    public function handle($params)
    {
        ...
        $result = kernel::single('topmanageapi_statement_orderAftersaleAnalyze')->ajaxTrade($postData);
        return $result;
    }
}
