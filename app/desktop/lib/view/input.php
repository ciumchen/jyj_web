...
class desktop_view_input
{
    function input_image($params)
    {
        ...
        $html = '<div class="image-input clearfix" gid="'.$domid.'">';
        ...
        $html.= '</div></div>';
        $html.= '<div class="image-input-handle" onclick="Ex_Loader(&quot;modedialog&quot;,function(){new imgDialog('.$url.',{handle:this});}.bind(this));">';
        $html.= '+</div>';
