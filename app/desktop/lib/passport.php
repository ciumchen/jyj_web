...
class desktop_passport {
	...
	*/
    ...
    {
        kernel::single('desktop_passwordLocker') ->checkLock( kernel::single('desktop_passwordLocker')->getUserIdByAccount($userId));

        if( empty($loginName) || !$password )
        {

            kernel::single('desktop_passwordLocker')->tryVerify(kernel::single('desktop_passwordLocker')->getUserIdByAccount($userId));
        ...
        {
            kernel::single('desktop_passwordLocker')->clean(kernel::single('desktop_passwordLocker')->getUserIdByAccount($userId));
