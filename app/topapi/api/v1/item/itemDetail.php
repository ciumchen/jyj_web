...
class topapi_api_v1_item_itemDetail implements topapi_interface_api{
    ...
    private function __getPromotion($itemId)
    {
        ...
        foreach($promotionInfo as $vp)
        {
            ...
            $postParams['fullminus_id'] = $basicPromotionInfo['rel_promotion_id'];
            $objMdlfullminus = app::get('syspromotion')->model('fullminus');
            $join_limit = $objMdlfullminus->getRow('join_limit',$postParams);
            $basicPromotionInfo['join_limit'] = $join_limit['join_limit'];
            if($basicPromotionInfo['valid']===true)
            {
                ...
                $pagedata['promotionTag'][$basicPromotionInfo['promotion_type']][] = [
                    ...
                    'join_limit'       => $basicPromotionInfo['join_limit'],
                ];
            }
        }
