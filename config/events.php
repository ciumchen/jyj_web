    ...
    */
    'listen' => [
        ...
        'user.login' => [
            ...
            ['sysuser_events_listeners_loginLog', 'sync'],
        ],
        ...
        //订单结算确认
        'trade.settlement.confirm' => [
            ['sysclearing_events_listeners_updateSettlementStatus@update', 'async'],
        ],
        ...
        'category.remove' => [
         ...
         //虚拟分类相关
         'virtualcat.save' =>[
             ['syscategory_events_listeners_updateVirtualCatList@updateVirtualcatList', 'sync'],
         ],
        ...
        'shop.open' => [
            //添加保证金初始化数据
            ['sysfinance_events_listeners_guaranteeMoney@init', 'sync'],
            //开启新店铺装修
            ['sysshop_events_listeners_openNewDecorate@open','sync'],
        ],
         //发送保证金欠缴/预警通知
        'guaranteemoney_status.notify' => [
            ['sysfinance_events_listeners_updateStatus@notify', 'sync'],
        ],

        //定向发放优惠
        'syspromotion.distribute.create' => [
            ['syspromotion_distribute_listenner_distribute@create', 'sync'],
        ],

        //定向发放优惠细节具体执行
        'syspromotion.distribute.detail.send' => [
  //        ['syspromotion_distribute_listenner_detail@consume', 'sync'],
            ['syspromotion_distribute_listenner_smsNotify@notify', 'sync'],
            ['syspromotion_distribute_listenner_emailNotify@notify', 'sync'],
        ],
