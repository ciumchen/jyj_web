...
//      'user.check' => ['uses' => 'sysuser_api_user_account_check@check', 'version' => ['v1']],
         ...
         *=======================================
         */
         'systag.tag.save'   => ['uses'=>'systag_api_tag_create@save', 'version'=>['v1']],
         'systag.tag.list'   => ['uses'=>'systag_api_tag_list@get', 'version'=>['v1']],
         'systag.tag.delete' => ['uses'=>'systag_api_tag_delete@delete', 'version'=>['v1']],
         'systag.tag.getByName' => ['uses'=>'systag_api_tag_getByName@get', 'version'=>['v1']],
         'systag.rel.bind'   => ['uses'=>'systag_api_rels_bind@bind', 'version'=>['v1']],
         'systag.rel.unbind' => ['uses'=>'systag_api_rels_unbind@unbind', 'version'=>['v1']],
         'systag.rel.getTagsByOwner' => ['uses'=>'systag_api_rels_getTagsByOwner@get', 'version'=>['v1']],
         'systag.rel.getRelsByTag' => ['uses'=>'systag_api_rels_getRelsByTag@get', 'version'=>['v1']],
